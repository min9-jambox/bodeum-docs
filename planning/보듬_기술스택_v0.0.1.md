...
> **기준 문서**: `보듬_PRD_v0.0.1.md`, `보듬_아키텍처_설계서_v0.0.1.md`
> **작성일**: 2026-03-18
...
| 채택 근거 | 설명 |
|----------|------|
| **JSONB = 유연한 돌봄 기록** | `record_draft` 필드를 JSONB로 저장. 신체/인지/정서/특이사항의 스키마 변경에 마이그레이션 없이 대응 |
...
FROM care_records r,
     JSON_TABLE(r.record_draft, '$' COLUMNS (
         physical TEXT PATH '$.physical',
         cognitive TEXT PATH '$.cognitive',
         emotional TEXT PATH '$.emotional'
     )) AS jt
...
| **공단 API** | 건보공단 | 급여제공기록 연동 (규제 대응) | 3 |
| **ERP** | 다수 | 기관 ERP 시스템 연동 | 3 |
...
| 문서 | 버전 | 용도 |
|------|:----:|------|
| 보듬_PRD_v0.0.1.md | v0.0.1 | 제품 요구사항 정의서 (원천) |
