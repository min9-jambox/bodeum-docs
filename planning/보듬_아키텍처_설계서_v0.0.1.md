...
> **문서 버전**: 0.0.1
> **작성일**: 2026-03-18
> **기반 문서**: 보듬_PRD_v0.0.1.md, 보듬_엔티티_명세서_v0.0.1.md, 보듬_API_명세서_v0.0.1.md
...
graph TB
    ...
    subgraph "Service Layer"
        ...
        CARE["Care Service<br/>(Kotlin/Spring Boot)"]
        AI["AI Pipeline Service<br/>(Kotlin/Spring Boot)"]
...
| **Care Service** | 센터·수급자·기록 관리 | Center, Client, Guardian, Assignment, CareRecord, AlimtalkLog | S3, SQS |
| **AI Pipeline** | 음성→텍스트 변환·생성 | (없음 — stateless) | Whisper, GPT-4o-mini, S3, SQS |
...
| `AlimtalkRequested` | Care | Notification | `bodeum-alimtalk-requested` | 제출 → 알림톡 발송 |
...
| Care Service 확장 | 지오펜싱, 분석 대시보드, 프리미엄 리포트 기능 추가 |
| AI Pipeline 확장 | 정합성 검증 엔진, 다국어 STT 파이프라인 |
...
| 서비스 추가 | Integration Service (공단/ERP 연동) |
| AI 확장 | 건강 트렌드 분석 모델, 이상 징후 감지 |
